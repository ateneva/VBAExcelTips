Attribute VB_Name = "OutCampaignDailySpend"
Option Explicit
...
'~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    With ActiveSheet
        ...
        For Each PF In PT.PivotFields
            ...
            If PF.name = "SectionID" Then PF.Orientation = xlRowField
    ...
    'adjust sorting and layouts for row fields --> it needs to be in a separate loop; if defined when the field is being added, it's not working
        For Each PF In PT.RowFields
            If PF.name = "SectionID" Then PF.AutoSort xlDescending, "Impressions "
        Next PF
